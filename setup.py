...
versionName = sys.version.split()[0].split('.')
versionName = versionName[0] + '.' + versionName[1]
core_path = source_path + platform.system() + '/lib' + platform.architecture()[0][:2] + '/v' + versionName
